...
n=20;
resultKnn = zeros(n,1); %%%%%% luu ket qua vao bien results
AUCKnn = zeros(n,1);
for i= 1:n
...
modelB = fitcknn(X_train, Y_train,'NumNeighbors',6,'DistanceWeight','squaredinverse' ); % train svm
