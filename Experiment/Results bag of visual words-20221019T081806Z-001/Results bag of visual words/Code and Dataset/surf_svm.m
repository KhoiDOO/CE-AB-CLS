...
load( 'Abnorm1SURF64select100Blue.mat');
abnorm1_A = A; %sua A thanh B
load( 'Abnorm2SURF64select100Blue.mat');
abnorm2_A =A;
load( 'Norm1SURF64select100Blue.mat');
norm1_A = A;
load( 'Norm2SURF64select100Blue.mat');
norm2_A = A;
clear A;
%%%%%%%%%%%   SURF
...
%%%%%%%%%%%%%%%%%%
% testMatrix = evaluate(model, X_test);
